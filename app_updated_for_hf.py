...
async def load_models():
    ...
    try:
        ...
        # Use VITS multilingual model (supports Persian)
        # Using GPU if available for faster processing
...
async def text_to_speech(text: str):
    ...
    try:
        ...
        # Generate speech with Persian language
        # YourTTS model supports multiple languages including Persian
        tts_model.tts_to_file(
            text=text,
            file_path=output_path,
            language="fa",  # Persian language code
            speaker="female-en-5"  # Using a female speaker
        )
